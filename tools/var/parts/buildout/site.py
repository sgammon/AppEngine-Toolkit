...
def addsitepackages(known_paths):
    ...
    base = os.path.dirname(base)
    base = os.path.dirname(base)
    setuptools_path = join(base, 'eggs/distribute-0.6.21-py2.6.egg')
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        join(base, 'eggs/distribute-0.6.21-py2.6.egg'),
    ...
    original_paths = [
        '/usr/local/lib/wxPython-unicode-2.8.12.1/lib/python2.6/site-packages',
        '/usr/local/lib/wxPython-unicode-2.8.12.1/lib/python2.6/site-packages/wx-2.8-mac-unicode',
        '/Library/Python/2.6/site-packages',
        '/usr/local/lib/wxPython-unicode-2.8.12.1/lib/python2.6',
